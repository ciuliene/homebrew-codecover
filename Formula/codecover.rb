class Codecover < Formula
    ...
    url "https://github.com/ciuliene/homebrew-codecover/releases/download/1.0.5/codecover-v1.0.5.tar.gz"
    ...
    test do
        assert_match "v1.0.5", shell_output("#{bin}/codecover --version")
    end
end
