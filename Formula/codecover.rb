class Codecover < Formula
    ...
    url "https://github.com/ciuliene/homebrew-codecover/releases/download/1.0.4/codecover-v1.0.4.tar.gz"
    ...
    test do
        assert_match "v1.0.4", shell_output("#{bin}/codecover --version")
    end
end
